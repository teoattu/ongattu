  ...
  <section class="doneaza__main">
    {#if windowWidth > 1024}
      ...
      <div class="doneaza__main__content">
        ...
        <div class="textArea">
          <p>Încă din 2014 voluntarii nostri au contribuit cu entuziasm, idei, și o puternică dorință de rezolva problemele comunității! Împreună cu ei și cu ajutorul din partea ta, asociația a crescut și a ajuns la cât mai mulți oameni!
          </p>
          <p>îți mulțumim că ne ești alături și contribui la fericirea și viitorul grupurilor defavorizate!</p>
          <br>
          <a href="https://secure.mobilpay.ro/buy-product/c8en7ker"><Button>Donează</Button></a>
          <br>
          <MobilePaySvg/>
        </div>
      </div>
    {:else}
      ...
      <div class="textArea">
        <h3>Când donezi pentru o cauza nobilă, câștigi mai mult decât pierzi </h3>
        <p>Încă din 2014 voluntarii nostri au contribuit cu entuziasm, idei, și o puternică dorință de rezolva problemele comunității! Împreună cu ei și cu ajutorul din partea ta, asociația a crescut și a ajuns la cât mai mulți oameni!</p>
        <p>îți mulțumim că ne ești alături și contribui la fericirea și viitorul grupurilor defavorizate!</p>
        <br>
        <a href="https://secure.mobilpay.ro/buy-product/c8en7ker"><Button>Donează</Button></a>
        <br>
...
<style lang="scss">
  ...
  .doneaza {
    ...
    @media screen and (min-width: 1024px) {
      background-image: url("/images/doneaza/lgBackground.png");
    }
    &__main {
      display: flex;
      padding: 80px 1rem;
